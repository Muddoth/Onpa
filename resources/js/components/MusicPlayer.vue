<template>
    <div class="fixed bottom-0 left-[20%] w-[80%] bg-slate-800 border-t border-slate-700 z-50 shadow-lg rounded-t-xl">

        <div
            class="flex flex-col sm:flex-row items-center justify-between p-4 max-w-5xl mx-auto space-y-3 sm:space-y-0">

            <!-- Song Info -->
            <div class="flex items-center space-x-4">
                <img :src="song?.image_path ?? defaultImage"
            ...
            <div class="flex items-center space-x-4">
                ...
                <button @click="togglePlay"
                    ...
                    <!-- Play Icon -->
                    <svg v-if="isPaused" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none"
