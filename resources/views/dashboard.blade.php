...
<body class="bg-gray-900 flex">
    ...
    <aside class="w-1/5 bg-gray-800/50 text-white min-h-screen p-6">
        ...
        <nav class="flex flex-col space-y-4 text-xl">
            ...
            <a href="#" class="hover:text-pink-400 transition">Songs</a>
            <a href="#" class="hover:text-pink-400 transition">User Profile</a>
            <a href="#" class="hover:text-pink-400 transition">Record Mode</a>
        </nav>
    </aside>
                        ...
                        <div class="flex items-center">
                            <div class="flex space-x-3 p-2">
                                <button class="focus:outline-none">
                                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="#e43397"
                                ...
                                <button
                                    ...
                                    <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#e43397"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
