...
<x-layout title="Songs Page">
    ...
    <div class="w-full space-y-8">
        @forelse ($songs as $song)
            <div
                class="bg-gray-800 hover:scale-105 transition-transform duration-300 hover:shadow-xl rounded-2xl shadow-lg p-6 border border-gray-700 flex w-11/12 overflow-hidden mx-auto">
                ...
                <div class="flex flex-col w-full">
                    ...
                    <div class="flex p-5 border-b border-gray-700">
                        ...
                        <a class="w-fit h-fit bg-teal-500 hover:bg-teal-600 text-white font-semibold px-4 py-2 rounded-lg"
                            href="{{ route('songs.show', $song->id) }}">Edit </a>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row items-center p-5">
                        <div class="flex items-center space-x-3 p-2">
                            <!--Prev Button-->
                            <button class="focus:outline-none" data-id="{{ $song->id }}">
                            ...
                            <!-- Play button -->
                            <button
                                class="play-btn rounded-full w-10 h-10 flex items-center justify-center pl-0.5 ring-1 ring-pink-400 focus:outline-none"
                                data-id="{{ $song->id }}">
                    ...
                    <!-- Audio player -->
                    <div class="px-5">
                        <audio class="w-full mt-2 hidden-audio" data-id="{{ $song->id }}">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const progressBars = document.querySelectorAll('.bg-pink-500');
            ...
            playButtons.forEach(btn => {
                btn.addEventListener('click', () => {
                    ...
                    const progress = btn.closest('.bg-gray-800').querySelector('.bg-pink-500');
